...
//     * Start with a user that has notifications turned off (default setting)
//     * The fragment and these tests are no longer needed, they're just along for the ride for now in case that changes
//     */
//    @Before
//    public void setUp() {
//        testUserId = "test-user-id";
//        testUser_notificationsOn = new User("test-user-notifications_on", "test@email.com", "", testUserId, false, true, null, true);
//        testUser_notificationsOff = new User("test-user-notifications_off", "test@email.com", "", testUserId, false, true, null, false);
//    }
//
//    /**
